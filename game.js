...
monsterImage2.src = "images/hero.png";
...
var update = function (modifier) {
	...
	if (40 in keysDown) { // 按向下键，英雄往下移动
		hero.y += hero.speed * modifier;
		if(hero.y>480-40){hero.y=480-40;}
	...
	if (39 in keysDown) { // 按向右键，英雄往右移动
		hero.x += hero.speed * modifier;
		if(hero.x>512-40){hero.x=512-40;}
...
var render = function () {
	...
	a=monstersCaught*10+monstersCaught2*100
	ctx.fillText("得分: " + a, 32, 32);
